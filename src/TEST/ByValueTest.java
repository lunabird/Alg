...
public class ByValueTest {
    ...
    public static void main(String[] args) {
        ...
        // 建立并构造两个对象
        Person p1 = new Person("黄鹏", "女的");
        Person p2 = new Person("胖虎", "男的");
        ...
        // 分别构造数组对象
        arraya[0] = new Person("黄鹏", "女的");
        arraya[1] = new Person("胖虎", "男的");
        arrayb[0] = new Person("小兰", "女的");
        arrayb[1] = new Person("新一", "男的");
        ...
        System.out.println("对象数组内容交换并改变后：arraya[1] = " + arraya[1].toString());
        System.out.println("对象数组内容交换并改变后：arrayb[0] = " + arrayb[0].toString());
